...
namespace siptricks
{
	namespace fsm
	{
		...
		public:
			...
			AbstractState(StateContext &c, const State::Name& n = AbstractState::defaultName);
			virtual ~AbstractState();

			virtual State::Name getName() const { return mName; }

			void transitionTo(StateFactory::FactoryState factoryState);
