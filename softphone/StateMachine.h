...
namespace softphone
{
	namespace fsm
	{
		...
		{
		public:
			StateMachine(siptricks::fsm::StateFactory& factory, siptricks::fsm::StateChanger& changer, siptricks::fsm::Actions& actions);
			virtual ~StateMachine();

		private:
			siptricks::fsm::Actions& mActions;
			siptricks::fsm::StateContext mStateContext;
			siptricks::fsm::State* mCurrentState;
			siptricks::fsm::StateFactory& mFactory;
